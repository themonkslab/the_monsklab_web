...
class _$_Author implements _Author {
  const _$_Author({required this.name, required this.picture});
  ...
  @override
  String toString() {
    return 'Author(name: $name, picture: $picture)';
  }
...
abstract class _Author implements Author {
  const factory _Author(
      {required final String name, required final String picture}) = _$_Author;
