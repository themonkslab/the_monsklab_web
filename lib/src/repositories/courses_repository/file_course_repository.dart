...
abstract class FileCoursesRepository extends CoursesRepository {
  ...
  @override
  Future<Article?> fetchArticle(String articlePath, String sectionPath, String coursePath, String groupName) async {
...
class FileCoursesGroup extends ViewModel<CourseGroup> {
  ...
  factory FileCoursesGroup.fromMap(Map<String, dynamic> map) {
    return FileCoursesGroup(
      ...
      courses: map['courses'] != null ? List<FileCourse>.from(map['courses']?.map((x) => FileCourse.fromMap(x))) : [],
    );
  }
  ...
  CourseGroup toViewModel() {
    return CourseGroup(groupName: groupName, courses: courses.map((e) => e.toViewModel()).toList());
  }
...
class FileCourse extends ViewModel<Course> {
  ...
  factory FileCourse.fromMap(Map<String, dynamic> map) {
    return FileCourse(
      ...
      path: map['path'],
      sections:
          map['sections'] != null ? List<FileSection>.from(map['sections']?.map((x) => FileSection.fromMap(x))) : [],
    );
  }
...
class FileSection extends ViewModel<Section> {
  ...
  factory FileSection.fromMap(Map<String, dynamic> map) {
    return FileSection(
      ...
      articles: List<FileArticle>.from(map['articles']?.map((x) => FileArticle.fromMap(x))),
    );
  }
