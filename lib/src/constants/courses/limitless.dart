...
'''),
    ...
    CourseSection(title: 'Parte III', chapters: [
      CourseChapter(
          title: '🔥 Motivación sin límites (p165)',
          description: 'El qué y el por qué de nuestra chispa interna',
          author: const AppAuthor(name: 'Mau Di Bert', picture: ''),
          data: '''
# 🔥 Motivación sin límites (p165)
...
'''),
    ...
    CourseSection(title: 'Parte III', chapters: [
      CourseChapter(
          title: '🧘🏻‍♀️ Energía (p189)',
          description: 'Cómo proveernos del mejor combustible',
          author: const AppAuthor(name: 'Mau Di Bert', picture: ''),
          data: '''
## 🧘🏻‍♀️ Energía (p189)

<TODO articulo y linkear>
